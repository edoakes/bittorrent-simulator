...
parser = argparse.ArgumentParser(description='Simulate random regular graph')
...
parser.add_argument('--degree', default=5, type=int, help='degree of random regular graph')
...
class PeerManager(object):
    ...
    def __init__(self, peer_count, piece_count, transmit_limit, degree):
        self.peers = []
...
def main(args):
    peer_manager = PeerManager(args.peers, args.pieces, args.transmit_limit, args.degree)
    peer_manager.start()
